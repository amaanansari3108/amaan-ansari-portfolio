        ...
        >
          <AnimatePresence mode="popLayout">
            {projectsData.map((project, idx) => {
              const cardUrl = project.links?.[0]?.url;
              const cardContent = (
                <GlassCard hoverEffect={true} className="flex flex-col justify-between h-full relative">
                  <div>
                    {/* Top Bar inside Card */}
              ...
              return (
                ...
                >
                  {cardUrl ? (
                    <LinkPreviewTooltip url={cardUrl} className="h-full block">
                      {cardContent}
                    </LinkPreviewTooltip>
                  ) : (
                    cardContent
